...
└── ${session_id}/
    ...
    ├── request_context.json    # latest working context, system prompt, sequence and usage
    ├── request_context.pending.json # recovery record, present during a commit
    ├── artifacts/             # immutable tool outputs addressed by content SHA-256
    ├── log/
